        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-md">
              AI-powered blogging platform for developers, tech bloggers, and indie hackers.
              Create high-quality content faster and grow your audience.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/legal/licensing" className="text-muted-foreground hover:text-foreground transition-colors">
                  Licensing
                </Link>
              </li>
            </ul>
